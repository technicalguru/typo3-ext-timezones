...
$TCA['tt_content']['types']['list']['subtypes_excludelist'][$_EXTKEY.'_pi3']='layout';
t3lib_extMgm::addPlugin(Array('LLL:EXT:timezones/locallang_db.php:tt_content.list_type_pi3', $_EXTKEY.'_pi3'),'list_type');
